...
| **Lozengrad Hudut** | True Peak Limiter | True peak limiter with polyphase oversampling (1x/2x/4x/8x), harmonic inflate, dual-window auto-release, peak hold, lookahead, sidechain HPF, and scrolling waveform/GR display |
